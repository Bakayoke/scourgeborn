...
const sv = {
  ...
  correct: 'rätt',
  wrong: 'fel',
  voteFunnyHint: 'Rösta på den path som gick mest snett (även din egen). Poängen går till sista felgissningen.',
  voteFunny: 'Rösta',
  yourVote: 'Din röst',
  seconds: 's',
  submitted: 'inne',
  ...
  scores: 'Poäng',
  pointsHint: '+20 för rätt gissning · +10 per röst till den som skrev sista felet på pathen',
...
const en: typeof sv = {
  ...
  wrong: 'wrong',
  voteFunnyHint:
    'Vote for the path that went most wrong (including your own). Points go to the last wrong guess.',
  voteFunny: 'Vote',
  yourVote: 'Your vote',
  seconds: 's',
  submitted: 'in',
  ...
  scores: 'Scores',
  pointsHint: '+20 for a correct guess · +10 per vote to whoever wrote the last fail on that path',
