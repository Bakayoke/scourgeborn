...
const sv = {
  ...
  tutorialSend: '2. Skicka till laget (multi) eller byt till Synthesizer (solo)',
  tutorialDeliver: '3. Ge vaccin när du har rätt prov!',
  ...
  howToSteps: [
    ...
    'Extraktor → Synthesizer → Inkubator.',
...
const en: typeof sv = {
  ...
  tutorialSend: '2. Send to teammate (multi) or switch to Synthesizer (solo)',
  tutorialDeliver: '3. Deliver when you have the right sample!',
