...
const sv = {
  ...
  pulsekaosPitch: 'Osäker på vad ni ska spela? Kör Pulskaos — spela allt.',
  pulsekaosCta: 'Öppna pulskaos.com →',
  rematch: 'Spela igen',
...
const en: typeof sv = {
  ...
  pulsekaosPitch: 'Not sure what to play? Try Pulskaos — play everything.',
  pulsekaosCta: 'Open pulskaos.com →',
  rematch: 'Play again',
